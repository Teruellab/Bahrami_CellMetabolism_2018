...
load([datadir,'4x12hr_CombinedWithLinking.mat'])
...
figure,plot(frames./framesperhr,smoothedmat(highcells,:)','Color',[r, 0.8],'LineWidth',1)
hold on
% plot(frames./framesperhr,diffmean,'Color',r,'LineWidth',4)
plot(frames./framesperhr,smoothedmat(~highcells,:)','Color',[b .8],'LineWidth',1)
