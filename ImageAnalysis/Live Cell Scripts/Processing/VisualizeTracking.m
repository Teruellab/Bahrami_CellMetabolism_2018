...
% experimentpath='Live Cell Experiments\20170103-DualTag-Pulsing\';%'12072014-Michael-48hr-CC\';
...
shadingpath=[imagepath,'Scripts/ShadingImages/DCYTC 10x/'];
...
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tracefile=[datadir,'tracedata_',shot,'_WithLinkSigBound','.mat'];
videofile=[datadir,'numbertracking_nojitter_',shot,'.mat'];
