function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_9_mz_test(tf,lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,nucr,jitter,maxjump,debrisarea,H2BvsNLS,debugpackage)
