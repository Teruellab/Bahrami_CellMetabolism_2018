...
sigma=0.75*nucr/sqrt(2); %default 0.75, bin1:0.75 bin2:0.5
h=sigma^2*fspecial('log',[round(nucr*3) round(nucr*3)],sigma); %laplacian of gaussian default window [nucr*2 nucr*2]
...
% antimask = bwareaopen(nuc_mask,2500);
% nuc_mask = logical(nuc_mask-antimask);
