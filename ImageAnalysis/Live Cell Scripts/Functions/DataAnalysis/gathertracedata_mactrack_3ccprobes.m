function [tracedata,tracestats,motherstats,IFdata,samplecellsID,markedmitosis,lastcellmother]=gathertracedata_mactrack_3ccprobes(datadir,datafile,shot,motheroption,daughteroption,IFoption)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% tracedata = cat(3, CellMeasurements.MedianPPARg,CellMeasurements.IntegratedPPARg,...
%     CellMeasurements.MedianCEPB,CellMeasurements.IntegratedCEBP,...
%     CellMeasurements.MedianNuc3,CellMeasurements.IntegratedCyto3,...
%     CellMeasurements.IntegratedNuc4);
