function [tracedata,tracestats,motherstats,IFdata,samplecellsID,markedmitosis,lastcellmother]=gathertracedata_mactrack2(datadir,datafile,shot,motheroption,daughteroption,IFoption)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(datafile);
