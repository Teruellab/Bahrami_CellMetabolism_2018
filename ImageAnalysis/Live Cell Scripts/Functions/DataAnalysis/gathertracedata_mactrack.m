function [tracedata,tracestats,motherstats,IFdata,samplecellsID,markedmitosis,lastcellmother]=gathertracedata_mactrack(datadir,datafile,shot,motheroption,daughteroption,IFoption)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(datafile);
